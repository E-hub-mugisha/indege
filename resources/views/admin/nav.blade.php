...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            @foreach(\App\Models\Jobs::all() as $jobs)
            <a class="dropdown-item d-flex align-items-center" href="/jobs/{{ $jobs->job_type }}">
                <div class="mr-3">
                ...
                <div>
                    <div class="small text-gray-500">{{ $jobs->job_type }}</div>
                    <span class="font-weight-bold">{{ $jobs->job_title }}</span>
                </div>
            </a>
            @endforeach
            <a class="dropdown-item text-center small text-gray-500" href="/admin/view_jobs">Show All Alerts</a>
        </div>
    </li>
